...
class WordCloud(RectChart):
    def set_wordcloud_spec(
        self,
        ...
        is_word_mask_visible: types.Optional[bool] = None,
        word_mask_style_opts: types.Optional[opts.BaseStyleOpts] = None,
        word_mask_state_opts: types.Optional[dict] = None,
    ):
        self.options.update(
            {
                ...
                "word": wordcloud_opts,
                "wordMask": {
                    "visible": is_word_mask_visible,
                    "style": word_mask_style_opts,
                    "state": word_mask_state_opts,
                },
            }
        )
